...
def main(args):  
    ...
    model = NORM_Net_DeltaPhi_ODE2(modes, width, MATRIX_Output, INVERSE_Output, MATRIX_Input, INVERSE_Input).cuda()
    ...
    sava_path = current_directory + "/logs_ode/" + args.CaseName + "/"
