...
from model import NORM_net_DeltaPhi
...
def main(args):  
    ...
    model = NORM_net_DeltaPhi(modes, nodes, Fmodes, width, TIME_MATRIX, TIME_INVERSE, BASE_MATRIX, BASE_INVERSE, Nt).to(device) 
    ...
    for ep in range(epochs):
        ...
        for x, y in train_loader:
            ...
            # torch.Size([10, 1656, 121, 3]) torch.Size([10, 1656, 121, 3]) 
            # exit()                   
