...
class Continuous_DeltaPhi_Func(nn.Module):
    def __init__(self, modes, width, LBO_MATRIX, LBO_INVERSE):
        super().__init__()
        self.modes1 = modes
        self.width = width
        ...
        self.conv0 = Approximation_block(width, width, modes, LBO_MATRIX, LBO_INVERSE)
        self.conv1 = Approximation_block(width, width, modes, LBO_MATRIX, LBO_INVERSE)
        self.conv2 = Approximation_block(width, width, modes, LBO_MATRIX, LBO_INVERSE)
        self.conv3 = Approximation_block(width, width, modes, LBO_MATRIX, LBO_INVERSE)
        ...
        self.time_embed = nn.Linear(1, width)
...
class NORM_Net_ODE2(nn.Module):
    def __init__(self, modes, width, LBO_MATRIX, LBO_INVERSE, steps=6, coord_dim=1):
